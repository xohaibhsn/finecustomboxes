      ...
      <div className="bg-white border-b px-6 flex gap-6 overflow-x-auto">
        {(['quotes', 'contacts', 'products', 'blog'] as const).map((t) => (
          <button key={t} onClick={() => setTab(t)}
            className={`py-4 px-2 font-semibold capitalize border-b-2 transition whitespace-nowrap ${tab === t ? 'border-yellow-500 text-yellow-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button onClick={saveProduct} className="bg-gray-900 text-white px-6 py-3 rounded-lg font-black hover:bg-gray-800 transition">
                      Save Product
                    </button>
            ...
            {showBlogForm && (
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button onClick={saveBlogPost} className="bg-gray-900 text-white px-6 py-3 rounded-lg font-black hover:bg-gray-800 transition">
