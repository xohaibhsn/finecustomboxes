...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300 mt-16">
      {/* Trust Strip */}
      <div className="bg-emerald-700 py-4 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              <span>📞</span>
              <a href="tel:+15550000000" className="hover:text-emerald-400 transition">+1 (555) 000-0000</a>
            </div>
            <div className="flex items-center gap-2">
              <span>📧</span>
              <a href="mailto:info@finecustomboxes.com" className="hover:text-emerald-400 transition">info@finecustomboxes.com</a>
            </div>
            <div className="flex items-center gap-2">
              <span>📍</span>
        ...
        {/* Products */}
        <div>
          <h3 className="text-white font-semibold mb-4 uppercase text-xs tracking-wider">Our Products</h3>
          <ul className="space-y-2 text-sm">
            {[
              ...
              <li key={p.slug}>
                <Link href={`/products/${p.slug}`} className="hover:text-emerald-400 transition">{p.name}</Link>
              </li>
            ))}
          </ul>
        </div>
        ...
        {/* Why Us */}
        <div>
          <h3 className="text-white font-semibold mb-4 uppercase text-xs tracking-wider">Why Choose Us</h3>
